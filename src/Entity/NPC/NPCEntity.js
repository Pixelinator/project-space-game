...
import { player_entity } from '../Player/PlayerEntity'
import { player_state } from '../Player/PlayerState'
  ...
  class NPCController extends entity.Component {
    ...
    _LoadModels() {
      ...
      loader.load(this._params.resourceName, (glb) => {
        ...
        const texture = texLoader.load('./resources/monsters/Textures/' + this._params.resourceTexture)
